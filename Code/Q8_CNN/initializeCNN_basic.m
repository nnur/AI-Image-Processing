...
net.meta.trainOpts.continue = false;  % Set to true if continue training from previous point
...
net.layers{end+1} = struct('type', 'conv', ...
                           ...
                           'pad', 0) ;
net.layers{end+1} = struct('type', 'conv', ...
   'weights', {{f*randn(3,3,25,66, 'single'), zeros(1, 66, 'single')}}, ...
   'stride', 1, ...
   'pad', 1) ;     
...
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{f*randn(6,6,66,40, 'single'), zeros(1,40,'single')}}, ...
                           'stride', 1, ...
                           'pad', 0) ;
