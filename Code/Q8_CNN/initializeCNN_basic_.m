...
net.layers{end+1} = struct('type', 'conv', ...
                           ...
                           'stride', 1, ...
                           'pad', 2) ;                     
% output has dimensions 16 by 16 by 25

net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{f*randn(3,3,25,30, 'single'), zeros(1, 30, 'single')}}, ...
                           'stride', 1, ...
                           'pad', 1) ;    
% output 16 by 16 by 30
...
net.layers{end+1} = struct('type', 'pool', ...
                           ...
                           'stride', 2, ...
                           'pad', 0) ;
% output has dimensions 8 by 8 by 30                       
...
net.layers{end+1} = struct('type', 'conv', ...
                           'weights', {{f*randn(8,8,30,40, 'single'), zeros(1,40,'single')}}, ...
                           'stride', 1, ...
                           'pad', 0) ;
